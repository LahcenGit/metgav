(function($) {
    jQuery.fn.drop_uploader = function(options) {
        ...
        this.each(function(i, val) {
            ...
            $(v).before('<div class="text_wrapper">' + options.uploader_icon + ' <span class="text">' + options.uploader_text + ' <a href="#" style="color:#16B4B7 !important" class="' + options.browse_css_class + ' ' + options.browse_css_selector + '">' + options.browse_text + '</a></span></div>');
